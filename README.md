...
# Latest Work
Late one night I found myself in a coding mood, and added an update... a first pass at search with a search bar. I originally added a temporary button to do a hard-coded movie search for "Totoro?", which I've left, just because ;-).
